...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4 relative overflow-hidden selection:bg-indigo-500 selection:text-white">
      ...
      <div className="w-full max-w-md bg-gradient-to-br from-slate-900/90 via-slate-900/95 to-slate-950/90 border border-slate-800/80 backdrop-blur-2xl rounded-3xl p-8 sm:p-10 shadow-[0_0_50px_-12px_rgba(79,70,229,0.25)] relative z-10 animate-scale-in">
      ...
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 hidden md:flex items-center gap-6 text-[11px] font-bold text-slate-400 bg-slate-900/80 backdrop-blur-md px-6 py-2.5 rounded-full border border-slate-800 shadow-xl z-10">
        <span className="flex items-center gap-1.5 text-emerald-400">
          <Zap className="w-3.5 h-3.5" /> Instant UPI Expense Tracking
        </span>
